...
//		lnkCustomers_menu.click();
	    ...
	    wait.until(ExpectedConditions.elementToBeClickable(lnkCustomers_menu)).click();
	}
...
//		lnkCustomers_menuitem.click();
	    ...
	    // Step 1: Wait for DOM update after clicking main menu
	    try {
	        Thread.sleep(1000); // small delay so sub-menu appears
	    ...
	    try {
	        ...
	        // Step 3: Use JavaScript click if normal click fails
